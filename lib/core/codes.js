...
Core.Codes = (function () {
  ...
  var ADDRESS_USE_MAP = {
      ...
      "MC": "Mobile Contact",
      "PG": "Pager",
      "DE": "DirectTrust Email", //non-standard, CGM ONLY
      "SE": "Standard Email"     //non-standard, CGM ONLY
  };
  
    // Address use - HL7 v3 codeset
  // 2.16.840.1.113883.5.1119
  var ADDRESS_USE_SHORT_MAP = {
      "BAD": "bad",
      "CONF": "confidential",
      "H": "home",
      "HP": "home",
      ...
      "MC": "mobile",
      "PG": "pager",
      "DE": "directTrust",  //non-standard, CGM ONLY
      "SE": "email"         //non-standard, CGM ONLY
  };
  ...
  return {
    ...
    addressUse: lookupFnGenerator(ADDRESS_USE_MAP),
    reverseAddressUse: reverseLookupFnGenerator(ADDRESS_USE_MAP),
    addressUseShort: lookupFnGenerator(ADDRESS_USE_SHORT_MAP),
    reverseAddressUseShort: reverseLookupFnGenerator(ADDRESS_USE_SHORT_MAP)
  };
